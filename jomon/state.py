...
LEGACY_THREAT_INTENT_IDS = {
    ...
    "its marked aim was spoiled by a silent close cut": "intent.disrupted.long_knife",
    "hauled out of its chosen footing": "intent.disrupted.boat_hook",
    "shaken by the compact impact": "intent.dazed.flanged_mace",
    "driven out of close measure": "intent.disrupted.quarterstaff",
    "dragged toward the anchored fluke": "intent.disrupted.anchor_fluke",
    "bound by spilled resin; loses a turn pulling free": "intent.entangled.resin",
    "eyes stung by the lime cloud": "intent.dazed.lime",
    "prepared action interrupted by a close strike": "intent.disrupted.equipment_interrupt",
    ...
    "caught by fire; seeking clear ground": "intent.material.clear_ground",
    "caught by debris; seeking clear ground": "intent.material.clear_ground",
    "water breaks its prepared lane": "intent.material.break_prepared_lane",
    "smoke breaks its prepared lane": "intent.material.break_prepared_lane",
    "salt breaks its prepared lane": "intent.material.break_prepared_lane",
    "lime breaks its prepared lane": "intent.material.break_prepared_lane",
    "ash breaks its prepared lane": "intent.material.break_prepared_lane",
