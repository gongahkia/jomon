...
BUILD_SCENARIOS = (
    ...
    BuildScenario("mobile-hook-fighter", "Mobile hook fighter", "billhook", "rope", "porter watch", "sure footing", (), "hearthford", 0, "clear", False, False, "mobile hook", "pull a guard out of line and occupy the vacated footing", "attack"),
    ...
    BuildScenario("smoke-walker", "Smoke walker", "long knife", "smoke pot", "route survey", "wind listener", ("smoke lens",), "greenwold", 0, "crosswind", False, False, "smoke walker", "spend carried smoke for cover while retaining sight nearby", "sight_radius"),
