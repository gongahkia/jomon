...
DISCOVERIES = {
    ...
    "fletched arrows": ("ammunition", "Counted dry longbow arrows in a waxed wrap; each unit is one shot."),
    "sling shot pouch": ("ammunition", "Counted selected stones that fit a sling cup; each unit is one shot."),
    "quarrel case": ("ammunition", "Counted heavy arbalest quarrels in a rigid case; each unit is one shot."),
...
HELP_LINES = (
    ...
    "Pressure combines elapsed actions, geographic depth, noise, and valuables.",
