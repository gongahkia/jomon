...
CONTRACTS = (
    ...
    Contract("base:flare_path", "Flare Path", "Begin with 15 light; travel adds 3 pressure.", "Spend local light against global pressure.", "bright_but_loud"),
    Contract("base:marked_receipts", "Marked Receipts", "Damage against marked enemies gains 1.", "Sequence setup before payoff.", "cash_marks"),
    Contract("base:last_manifest", "Last Manifest", "The first casualty leaves 1 supply.", "Continue meaningfully after owner loss.", "casualty_cache"),
    Contract("base:feedback_lock", "Feedback Lock", "Applying stun or weak costs that owner 2 stress.", "Rotate control instead of hard-locking.", "control_recoil"),
    Contract("base:debt_engine", "Debt Engine", "Begin with one trait curse and 2 extra supplies.", "Accept burden for exceptional power.", "curse_bargain"),
    ...
    Contract("base:glass_bulwark", "Glass Bulwark", "Block gains 2; unused block inflicts 2 stress.", "Size defense instead of hoarding it.", "fragile_guard"),
    Contract("base:held_line", "Held Line", "Guarded rounds gain 2 less pressure; others gain 2 more.", "Trade actions for expedition time.", "guarded_clock"),
    ...
    Contract("base:firing_solution", "Firing Solution", "Moved owners' narrow-rank attacks gain 2 damage.", "Solve position before artillery.", "narrow_fire"),
    Contract("base:two_keys", "Two Keys", "One objective is needed; pressure begins at 600.", "Practice an objective rush.", "objective_sprint"),
    Contract("base:red_market", "Red Market", "At 480 pressure, combat rewards gain one option.", "Detour into a dangerous reward lane.", "pressured_rewards"),
    Contract("base:empty_locker", "Empty Locker", "Begin with two fewer supplies.", "Plan attrition and facility use.", "scarce_supply"),
    Contract("base:heat_sink", "Heat Sink", "At 50 stress deal 15% more; relief loses 25%.", "Build around stress as a resource.", "stress_furnace"),
    Contract("base:third_knock", "Third Knock", "Enemies visibly react to the third card each round.", "Sequence around a local reaction.", "third_card_reaction"),
    Contract("base:open_wounds", "Open Wounds", "A wounded hero gains focus after each wound tick.", "Carry attrition for immediate power.", "wound_dividend"),
    Contract("base:zero_margin", "Zero Margin", "Death's Door is 15% harsher; healing gains 25%.", "Choose when to gamble at the edge.", "zero_margin"),
)
