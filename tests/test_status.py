...
class StatusTests(unittest.TestCase):
    ...
    def test_status_payload_marks_current_stage_and_missing_product_pieces(self) -> None:
        ...
        self.assertTrue(payload["capabilities"]["implemented"]["browser_playable_game"])
        self.assertNotIn("browser_game", payload["capabilities"]["not_implemented"])
    ...
    def test_status_text_is_human_readable(self) -> None:
        ...
        self.assertIn("browser_playable_game: yes", text)
