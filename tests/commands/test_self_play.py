...
class SelfPlayCommandTests(CliCommandTests):
    ...
    def test_self_play_match_sandbox_command_writes_report_and_json(self) -> None:
        ...
        self.assertIn('id="event-window"', viewer_html)
        self.assertIn("turn-timeline", viewer_html)
        self.assertIn("seat-grid", viewer_html)
        self.assertIn("kj-score-chip", viewer_html)
