...
def _match_state_payload(state: SandboxEnvironmentState) -> dict[str, Any]:
    ...
    return {
        ...
        "hands": [[tile.notation for tile in hand] for hand in state.hands],
        "hand_sizes": payload["hand_sizes"],
        "discards": payload["discards"],
        "melds": payload["melds"],
        "kita_tiles": payload["kita_tiles"],
        "dora_indicators": payload["dora_indicators"],
        "wall_remaining": payload["wall_remaining"],
        "dead_wall_remaining": payload["dead_wall_remaining"],
        "drawn_tile": payload["drawn_tile"],
        "needs_discard": payload["needs_discard"],
        "rinshan_draw": payload["rinshan_draw"],
        "last_draw_was_final_live_wall": payload["last_draw_was_final_live_wall"],
        ...
        "pending_chankan_kind": payload["pending_chankan_kind"],
        "pending_kita_tile": payload["pending_kita_tile"],
        "pending_kita_seat": payload["pending_kita_seat"],
        "pending_abortive_draw_reason": payload["pending_abortive_draw_reason"],
        "abortive_draw_after_discard_reason": payload["abortive_draw_after_discard_reason"],
        "pending_reaction_seats": payload["pending_reaction_seats"],
        "riichi_seats": payload["riichi_seats"],
        "double_riichi_seats": payload["double_riichi_seats"],
        "riichi_pending_discard_seats": payload["riichi_pending_discard_seats"],
        "ippatsu_seats": payload["ippatsu_seats"],
        "terminal_reason": payload["terminal_reason"],
        "game_finished": payload["game_finished"],
    }
