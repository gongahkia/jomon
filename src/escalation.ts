...
const arcs: Record<Biome, readonly ArcTemplate[]> = {
  ...
  floodedRuins: [{ id: 'floodgate', promise: 'cross the wet floodplain edge', landmark: 'anchored sluice', encounter: 'current network patrol', ecology: 'storm floodgate disruption', payoff: 'raise the tidal floodgate' }, { id: 'drowned-archive', promise: 'recover the drowned archive', landmark: 'archive island', encounter: 'reef ambush', ecology: 'undertow surge', payoff: 'surface the archive' }],
  ...
  frostReliquary: [{ id: 'winter-seal', promise: 'leave the cold shore for the marked ice', landmark: 'pressure-ridge shelter', encounter: 'ice-hunter patrol', ecology: 'whiteout pressure', payoff: 'open the frozen reliquary' }, { id: 'glacier-vow', promise: 'trace the wind-marked lake route', landmark: 'sheltered hollow', encounter: 'whiteout oracle screen', ecology: 'pressure-crack freeze', payoff: 'wake the frozen reliquary' }]
}
