...
const arcs: Record<Biome, readonly ArcTemplate[]> = {
  ...
  furnace: [{ id: 'kiln-heart', promise: 'reach the kiln heart', landmark: 'furnace lift', encounter: 'cinder guard line', ecology: 'smoke backdraft', payoff: 'quench the kiln heart' }, { id: 'slag-route', promise: 'chart the slag route', landmark: 'slag spillway', encounter: 'terrace pursuers', ecology: 'lift-chain surge', payoff: 'open the slag gate' }],
