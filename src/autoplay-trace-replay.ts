...
export const replayAutoplayTrace = (document: AutoplayTraceDocument): AutoplayTraceReplayResult => {
  ...
  let state = newRun(first.replay.seed, first.replay.biome, first.replay.areaFloor, first.replay.initialHero, [], [], first.replay.areaOrder, first.replay.campaignCycle, first.replay.companions, first.replay.companionDeathMode ?? 'injury')
