...
export const replayAutoplayTrace = (document: AutoplayTraceDocument): AutoplayTraceReplayResult => {
  ...
  let state = newRun(first.replay.seed, first.replay.biome, first.replay.areaFloor, undefined, [], [], undefined, first.replay.campaignCycle, first.replay.companions, first.replay.companionDeathMode ?? 'injury')
