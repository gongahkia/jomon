...
export { assertCompanion, cloneCompanion, cloneCompanions, companionErrors, companionLeadForRescue, companionLeadsForRescues, loseCompanionForRescue } from './engine/companions'
