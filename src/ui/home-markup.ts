...
const modeCards = () => `<section class="title-menu panel" aria-label="choose a game mode"><header><p class="eyebrow">CHOOSE A MODE</p><h2>how do you want to play?</h2><p>Set up a local campaign or play with friends.</p></header><div class="mode-grid"><article class="mode-card"><p class="eyebrow">LOCAL</p><h3>couch campaign</h3><p>Play solo or pass one device between golfers. AI fills any open enemy seats.</p><button class="primary" data-home-mode="local">choose campaign</button></article><article class="mode-card"><p class="eyebrow">LOCAL</p><h3>local multiplayer</h3><p>Build a shared-screen match for two or more players on one device.</p><button class="primary" data-home-mode="local-multiplayer">choose local multiplayer</button></article><article class="mode-card"><p class="eyebrow">ONLINE</p><h3>multiplayer</h3><p>Host a private room or join an existing table with a room code.</p><button class="primary" data-home-mode="multiplayer">choose multiplayer</button></article></div></section>`;

const localCard = (view: HomeView) => `<section class="setup-shell"><article class="home-card panel"><div class="card-back"><button data-home-mode="modes">← all modes</button><p class="eyebrow">LOCAL PARTY</p></div><h2>couch campaign</h2><p>Pass the device between golfers. AI fills any enemy seats.</p>${configFields(view.config, 'local')}<div class="home-actions"><button class="primary" data-start-local>start campaign</button><button data-quick-start-local>quick start</button></div><p class="hint">Quick start skips wagering windows and uses seeded automatic slot results.</p></article></section>`;

const localMultiplayerCard = (view: HomeView) => `<section class="setup-shell"><article class="home-card panel"><div class="card-back"><button data-home-mode="modes">← all modes</button><p class="eyebrow">LOCAL MULTIPLAYER</p></div><h2>shared-screen match</h2><p>Build a turn-based match for two or more golfers on one device.</p>${configFields(view.config, 'local-multiplayer', 2)}<div class="home-actions"><button class="primary" data-start-local-multiplayer>start shared match</button><button data-quick-start-local-multiplayer>quick start together</button></div><p class="hint">One active-ball camera follows the current turn on large courses.</p></article></section>`;
