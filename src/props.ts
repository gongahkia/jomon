...
export const PROP_DEFINITIONS = [
  ...
  define({ id: 'mine.brokenCart', biome: 'mine', name: 'broken cart', description: 'A splintered cart rests beside its rail.', glyph: 'C', color: '#c9a06e', terrain: ['floor', 'rail'], tags: ['route', 'force', 'salvage'], hooks: ['operate', 'bomb', 'force', 'throw'], activationReward: 'ropeBundle', effectReward: 'rock' }),
  ...
  define({ id: 'mine.discardedParcel', biome: 'mine', name: 'discarded parcel', description: 'A sealed bundle lies under a film of ash.', glyph: '?', color: '#d9c27e', terrain: ['floor', 'support'], tags: ['cache', 'salvage'], hooks: ['operate', 'bomb', 'fire', 'throw'], activationReward: 'ropeBundle', effectReward: 'key' }),
