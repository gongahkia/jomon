...
import { isValidFoundationWorld, upgradeFoundationWorldStateV16, upgradeFoundationWorldV13, upgradeFoundationWorldV14, upgradeFoundationWorldV15 } from './world'
...
const upgradeLegacyPersistenceBackupBundle = (value: unknown): PersistenceBackupBundle | undefined => {
  ...
  try {
    if (value.kind === 'active-world') {
      ...
      try { world = upgradeFoundationWorldStateV16(value.world) } catch { try { world = upgradeFoundationWorldV15(value.world) } catch { try { world = upgradeFoundationWorldV14(value.world) } catch { world = upgradeFoundationWorldV13(value.world) } } }
    ...
    try { chronicleWorld = upgradeFoundationWorldStateV16(value.chronicle.world) } catch { try { chronicleWorld = upgradeFoundationWorldV15(value.chronicle.world) } catch { try { chronicleWorld = upgradeFoundationWorldV14(value.chronicle.world) } catch { chronicleWorld = upgradeFoundationWorldV13(value.chronicle.world) } } }
