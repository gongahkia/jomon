...
describe('medieval performance fixture contract', () => {
  ...
  it('records reproducible selected-world, due-event, retained-state, canonical-byte, and pure-presentation regressions', () => {
    ...
    expect(scenarios.map(scenario => [
      ...
      ['sheltered-reach-focused', 192055, 256982, 64927, 12, 19, 2, 2796],
      ['sheltered-reach-balanced', 192301, 275077, 82776, 16, 25, 2, 3716],
      ['sheltered-reach-deep', 192033, 280565, 88532, 18, 27, 2, 4212],
      ['watershed-focused', 196146, 261020, 64874, 12, 19, 2, 2806],
      ['watershed-balanced', 196016, 284301, 88285, 17, 27, 2, 3959],
      ['watershed-deep', 196018, 295743, 99725, 21, 31, 2, 4950],
      ['far-coast-focused', 210082, 274875, 64793, 12, 19, 2, 2805],
      ['far-coast-balanced', 209699, 303504, 93805, 18, 29, 2, 4199],
      ['far-coast-deep', 209424, 314778, 105354, 22, 33, 2, 5196]
    ])
