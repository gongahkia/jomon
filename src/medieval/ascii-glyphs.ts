...
const authoredEntries = [
  ...
  glyph('work:mill-race-response', 'work', '&', 'Mill race worksite', 'Hearthford mill-race worksite.', 'Hearthford mill-race worksite; action cue is present.', 'actionText', 'ready', ['future-jomon-deck', 'future-settlement-map'], ['adult-labour', 'civil-life', 'commerce', 'craft', 'settlement'], 'adults-only'),
