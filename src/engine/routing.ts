...
export interface ScreenRoute { screen: Screen; biome: Biome; siteId?: string; heirSeed?: number; hubAction?: HubAction; sealedPackageAction?: 'open' | 'deliver' | 'refuse' | 'abandon'; companionAction?: { id: string; action: CompanionLodgeAction }; companionControlMode?: CompanionControlMode; codexPage?: number }
