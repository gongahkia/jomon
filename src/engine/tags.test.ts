...
describe('tag and modifier evaluation', () => {
  it('queries item, skill, script, terrain, and actor tags canonically', () => {
    ...
    expect(queryTags(query)).toEqual(['actor', 'arcane', 'cleave', 'damage', 'ember', 'equipment', 'fire', 'gas', 'hostile', 'item', 'marked', 'monster', 'sapper', 'script', 'skill', 'strength', 'untyped', 'weapon', 'wilds'])
