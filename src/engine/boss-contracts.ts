...
const contracts: Record<Biome, BossContract> = {
  ...
  caverns: { id: 'caverns:tidemaw', arena: 'storm-tide chamber', phases: { pressure: { terrain: 'current', telegraph: 'geode-fissure', counterplay: 'brace at an anchor' }, cataclysm: { terrain: 'deepWater', telegraph: 'guardian-slam', counterplay: 'preserve a dry shelf' } }, adds: ['artillery', 'controller'], reward: 'relic' },
