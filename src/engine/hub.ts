...
import type { Biome, CampaignCycle, Companion, CompanionControlMode, CompanionDeathMode, Hero, HubState, ItemId, Point } from '../types'
import { purchaseBlocker } from './economy'

export type HubAction = 'routes' | 'roster' | 'shop' | 'outfitter' | 'continuation'
export interface HubOptions { hero?: Hero; biome?: Biome; notice?: string; position?: Point; cycle?: CampaignCycle; companions?: Companion[]; companionControlMode?: CompanionControlMode; companionDeathMode?: CompanionDeathMode }
export interface HubView { courierName: string; state: HubState; hero?: Hero; stock?: ItemId[]; equipment?: ItemId[]; notice?: string; position?: Point; cycle?: CampaignCycle; companions?: Companion[]; companionControlMode?: CompanionControlMode; companionDeathMode?: CompanionDeathMode }
