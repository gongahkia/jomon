...
export const MONSTERS: MonsterDefinition[] = [
  ...
  { id: 'magma', name: 'Shore Newt', glyph: 'n', color: '#73b6c1', health: 12, attack: 8, defense: 11, speed: 105, ai: 'chase', xp: 25, biome: 'caverns', tags: ['caverns', 'water', 'mobility'] },
  { id: 'echo', name: 'Echo Bat', glyph: 'e', color: '#ba9ddd', health: 9, attack: 7, defense: 12, speed: 140, ai: 'wander', xp: 26, biome: 'caverns', tags: ['caverns', 'darkness', 'echo'] },
  { id: 'seer', name: 'Grotto Seer', glyph: 's', color: '#ba8ae7', health: 13, attack: 9, defense: 12, speed: 95, ai: 'ranged', xp: 30, biome: 'caverns', tags: ['caverns', 'darkness', 'telegraph'] },
  { id: 'slug', name: 'Tide Slug', glyph: 'u', color: '#a8c5cf', health: 19, attack: 8, defense: 15, speed: 65, ai: 'chase', xp: 31, biome: 'caverns', tags: ['caverns', 'water', 'cover'] },
  { id: 'cinderimp', name: 'Brine Skulker', glyph: 'i', color: '#8ed9de', health: 10, attack: 7, defense: 10, speed: 100, ai: 'ranged', xp: 28, biome: 'caverns', tags: ['caverns', 'water', 'telegraph'] },
  { id: 'fumeeel', name: 'Tide Eel', glyph: 'u', color: '#8fc59a', health: 13, attack: 7, defense: 12, speed: 100, ai: 'chase', xp: 29, biome: 'caverns', tags: ['caverns', 'water', 'tide', 'mobility'] },
  ...
  { id: 'crystalpuller', name: 'Undertow Puller', glyph: 'p', color: '#9ecce3', health: 14, attack: 7, defense: 13, speed: 90, ai: 'ranged', xp: 33, biome: 'caverns', tags: ['caverns', 'water', 'displacement', 'telegraph'] },
  { id: 'geode', name: 'Tidemaw', glyph: 'G', color: '#8ce5f2', health: 62, attack: 12, defense: 16, speed: 100, ai: 'guardian', xp: 115, biome: 'caverns', tags: ['caverns', 'water', 'current'] },
  ...
  { id: 'tombWarden', name: 'Tomb Warden', glyph: 't', color: '#9d8b76', health: 29, attack: 14, defense: 21, speed: 85, ai: 'chase', xp: 80, biome: 'burial', tags: ['burial', 'grave', 'counterplay'], terrainAffinity: ['graveSoil'] },
  { id: 'graveWisp', name: 'Grave Wisp', glyph: 'w', color: '#e0c9f0', health: 14, attack: 15, defense: 15, speed: 145, ai: 'wander', xp: 67, biome: 'burial', tags: ['burial', 'spirit', 'light'], terrainAffinity: ['spiritPath'] },
