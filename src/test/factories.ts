...
export const createFloor = (overrides: Partial<Floor> = {}): Floor => {
  ...
  return { index: 0, biome: 'mine', seed: 1, tiles: floorTiles, actors: [], items: [], props: [], milestones: [], start, exit, guardianDefeated: true, objective: objectiveForFloor(0), telegraphs: [], ...overrides }
}
