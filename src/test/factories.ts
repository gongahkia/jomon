...
export const createHero = (overrides: Partial<Hero> = {}): Hero => ({
  ...
  stats: { strength: 2, agility: 2, vitality: 2, intellect: 2 }, skills: [], inventory: [], equipment: {}, conditions: [], cooldowns: {}, traversalTools: [], boons: {}, safePositions: [], ...overrides
})
...
export const createFloor = (overrides: Partial<Floor> = {}): Floor => {
  ...
  return { index: 0, biome: 'mine', seed: 1, width: MAP_WIDTH, height: MAP_HEIGHT, layoutId: 'fixture', tiles: floorTiles, actors: [], items: [], props: [], milestones: [], start, exit, guardianDefeated: true, objective: objectiveForFloor(0), telegraphs: [], ...overrides }
}

export const createRun = (overrides: Partial<RunState> = {}): RunState => ({ version: 4, seed: 1, floor: createFloor(), hero: createHero(), messages: [], status: 'playing', turn: 0, ...overrides })
