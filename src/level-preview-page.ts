...
main.innerHTML = '<header class="level-preview-header"><div><p class="level-preview-kicker">LOCAL DEBUG MODE</p><h1>Level generation audit</h1></div><div class="level-preview-header-actions"><a class="level-preview-game-link" href="./">OPEN GAME</a><div class="level-preview-share"><span>SHARE AUDIT</span><code id="level-preview-query"></code></div></div></header>' +
