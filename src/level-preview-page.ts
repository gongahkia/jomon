...
function renderAudit(preview: LevelPreview): void {
  ...
  contentOutput.textContent = [
    ...
    '',
    'side spaces',
    'rooms: ' + metrics.sideSpaces.total,
    'rewards: ' + countLines(metrics.sideSpaces.rewards),
    'transitions: ' + countLines(metrics.sideSpaces.transitions),
    '',
    'boon distances',
