...
def run_report(engine, *, elapsed_seconds: int | None = None, outcome: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "expedition_mode": state.expedition_mode,
        "active_modifiers": list(state.active_modifiers),
        "enabled_packs": list(state.enabled_packs),
        "base_victory": state.base_victory,
        "loop_depth": state.loop_depth,
        "score": state.score,
        "boss_sequence": list(state.boss_sequence),
