...
comparison, local gameplay artifacts, and sandbox experiments. The external-baseline path is
...
summaries, static gameplay assets, benchmark dashboards, and sandbox reports.
...
\href{../media/play.mp4}{docs/media/play.mp4}, and
...
Gameplay clip & Rendered local gameplay surface generated by \texttt{kenjaku play --no-serve}. \\
\bottomrule
\end{tabular}
\end{table}
