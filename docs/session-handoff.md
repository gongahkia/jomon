...
- Current work slice: added `benchmark-discard-mlp` for small PyTorch discard MLP comparisons
  ...
  dealer-aware ron/tsumo payment handling plus visible-dora/red-five bonus han. This is still not hand
...
- `kenjaku.simulation.environment` exposes `kenjaku-sandbox-environment-v0` state plus
  ...
  basic dealer-aware win payment estimates, visible-dora/red-five score-estimate bonus han, and
...
- The sandbox environment boundary is intentionally incomplete. Do not build PPO, population
  ...
  dealer-aware payment, visible/red dora, and next-round dealer/honba/round-wind helper slices,
  ippatsu scoring, full yaku-aware open/kan hand legality, complete rinshan yaku/scoring semantics,
