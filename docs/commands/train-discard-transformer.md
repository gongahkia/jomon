...
Train a PyTorch transformer masked-logit discard policy.
...
- Keep model dimensions tiny for fixture smokes.
- Transformer scaffolding does not imply release-strength policy weights.

## Help

```text
usage: kenjaku train-discard-transformer [-h] [--epochs EPOCHS]
