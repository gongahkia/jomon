...
The validator checks that the bundle and all three selected report paths are ignored, source
commands and labels are recorded, report input paths exist under ignored non-fixture paths,
