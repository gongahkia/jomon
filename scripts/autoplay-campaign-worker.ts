...
const report = runAutoplay(newSeededCampaignRun(seed), { mode: profile.mode, policy: profile.policy, turnLimit, captureTrace: process.env.CAMPAIGN_AUTOPLAY_TRACE === '1', traceLimit: 24 })
