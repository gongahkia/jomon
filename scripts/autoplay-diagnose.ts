...
import { autoplayCandidateDiagnostics, autoplayDecision, autoplayHasStrategicRoute, autoplayObjectiveRouteDiagnostics, autoplayOptionalDiagnostics, autoplayResourceDiagnostics, autoplayStateFingerprint, autoplayToolDiagnostics, autoplayTraceFingerprint, createAutoplayContext, recordAutoplayTransition } from '../src/autoplay'
...
console.log(JSON.stringify({
  ...
  startedTurn: context.startedTurn,
  ...
  optionalDiagnostics: autoplayOptionalDiagnostics(state, modeValue as Exclude<AutoplayMode, 'off'>, policyValue as AutoplayPolicy, heuristicProfile),
