...
Builders can place fairway, rough, sand, ice, walls, boosters, conveyors, tee and cup markers, sweepers, timed gates, recovery pads, and chaos pads. Height is editable from zero to three, with adjacent tiles sharing ramp-edge heights. The white clubhouse board uses golf-green fairways, darker rough, sand bunkers, water-blue ice, and clean light controls.
