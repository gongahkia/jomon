...
Biome worlds use content schema 11 and save version 17. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
