...
Biome worlds use content schema 14 and save version 21. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
