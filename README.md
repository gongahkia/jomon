...
Biome worlds use content schema 17 and save version 24. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
