...
Biome worlds use content schema 12 and save version 19. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
