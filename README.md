...
- A reusable sandbox environment boundary with deterministic initial state, draw transitions, legal
  ...
  discard/call restrictions, a basic riichi deposit/stick ledger, individual reaction passes,
  ...
  4-player and static 3-player tile-set draw/discard turn-rotation plus terminal-outcome plumbing,
  auto-passing reaction windows because it has no ron/call policy yet. It is not a full
  riichi/Sanma simulator, complete riichi declaration/accounting model, yaku validator,
  dead-wall/kan-dora/rinshan implementation, scoring engine, or RL implementation.
