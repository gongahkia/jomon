...
Biome worlds use content schema 10 and save version 16. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
