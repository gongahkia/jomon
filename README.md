...
- A reusable sandbox environment boundary with deterministic initial state, draw transitions, legal
  ...
  simple live-wall replacement draws, a basic chankan ron/pass window before kakan replacement
  draw, individual reaction passes, ron-priority call gating, discard/call/tsumo/ron application,
  basic multi-ron terminal resolution, and simple terminal reward payloads. The self-play sandbox
  ...
  validator, dead-wall/kan-dora/rinshan implementation, complete robbing-kan/chankan model,
