...
Biome worlds use content schema 19 and save version 26. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
