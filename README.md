...
Biome worlds use content schema 9 and save version 15. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
