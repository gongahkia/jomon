...
Party Rules uses three representative biomes—Speedway, Quarry, and Carnival—and three authored course grammars—Ribbon, Fork, and Courtyard. Every generated hole marks a safe line, a skill line, and a conflict line. Before the campaign begins, the shuffler deterministically resolves every biome, layout, rules package, and one or two distinct chaos modifiers from the seed; players get the concise course headline but cannot steer or reroll it.
