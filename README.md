...
Biome worlds use content schema 18 and save version 25. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
