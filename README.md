...
Biome worlds use content schema 13 and save version 20. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
