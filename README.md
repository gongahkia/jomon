...
Biome worlds use content schema 20 and save version 29. The explicit migration chain supports the recorded version-26/content-20 baseline and versions 27–28; unknown content fingerprints and versions are rejected. See the [persistence reference](docs/PERSISTENCE.md).
