...
Contributor setup and PR expectations are in [CONTRIBUTING.md](CONTRIBUTING.md).
...
PYTHONPATH=src python3.13 -m kenjaku safety-advisor \
  --hand "1m 7m 5p 5s E" \
  --river "1m 4m 4p 4p 4p 4p 4s 4s 4s" \
  --active-riichi 1 --output text
