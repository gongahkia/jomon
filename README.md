...
- A reusable sandbox environment boundary with deterministic initial state, draw transitions, legal
  ...
  simple live-wall replacement draws, individual reaction passes, ron-priority call gating,
  ...
  validator, dead-wall/kan-dora/rinshan implementation, robbing-kan/chankan model, post-riichi
