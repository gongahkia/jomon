...
Biome worlds use content schema 8 and save version 12. Saves from earlier builds are rejected with an explicit version error rather than loaded incorrectly.
