...
[ASCII](https://en.wikipedia.org/wiki/ASCII)-art based [procedurally-generated](https://en.wikipedia.org/wiki/Procedural_generation) Dungeon Crawler [Roguelike](https://en.wikipedia.org/wiki/Roguelike) that lives in the browser *(with an [auto battler](https://en.wikipedia.org/wiki/Auto_battler) feature)*.
